export class spectrum128p2KeyboardMap {
  constructor() {
    this.keycodes = {
      ...
      8: { row: 4, mask: 0x01, capshift: true, type: 'key', layoutRowOrder: 14, inner1: 'DELETE', oneaction: true }, /* Delete (Delete PC Key) */
      ...
      190: { row: 7, mask: 0x04, symshift: true, type: 'key', layoutRowOrder: 48, inner1: '.' }, /* . (. PC Key) */
      ...
      189: { row: 5, mask: 0x02, symshift: true, type: 'key', layoutRowOrder: 51, inner1: ';' }, /* ; (- PC key)*/
      222: { row: 5, mask: 0x01, symshift: true, type: 'key', layoutRowOrder: 52, inner1: '"' }, /* " (´ PC key)*/
      37: { row: 3, mask: 0x10, capshift: true, type: 'key', layoutRowOrder: 53, inner1: '&#129144;' }, /* Left arrow (Left arrow PC Key) */
      39: { row: 4, mask: 0x04, capshift: true, type: 'key', layoutRowOrder: 54, inner1: '&#129146;' }, /* Right arrow (Right arrow PC Key) */
      32: { row: 7, mask: 0x01, type: 'key', layoutRowOrder: 55, oneaction: true, gridColumn: '6 / 10' }, /* space (Space PC Key) */
      38: { row: 4, mask: 0x08, capshift: true, type: 'key', layoutRowOrder: 56, inner1: '&#129145;' }, /* Up arrow (Up arrow PC Key) */
      40: { row: 4, mask: 0x10, capshift: true, type: 'key', layoutRowOrder: 57, inner1: '&#129147;' }, /* Down arrow (Down arrow PC Key) */
      188: { row: 7, mask: 0x08, symshift: true, type: 'key', layoutRowOrder: 58, inner1: ',' }, /* " */
