export class spectrum128pesKeyboardMap {
  constructor() {
    this.keycodes = {
      220: { row: 3, mask: 0x04, shiftKey: 16, type: 'key', layoutRowOrder: 1, inner1: 'VIDEO', oneAction: true }, /* TRUE VIDEO (º PC Key)) */
      187: { row: 3, mask: 0x08, shiftKey: 16, type: 'key', layoutRowOrder: 2, inner1: 'VIDEO', oneAction: true }, /* INV VIDEO (+ PC Key) */
      49: { row: 3, mask: 0x01, type: 'key', layoutRowOrder: 3, inner1: '1', inner2: '<div class="zx-key one"><span></span></div>', inner3: '!', top1: 'AZUL', top2: 'DEF FN' }, /* 1 (1 PC Key) */
      50: { row: 3, mask: 0x02, type: 'key', layoutRowOrder: 4, top1: 'ROJO', top2: 'FN', inner1: '2', inner2: '<div class="zx-key two"><span></span></div>', inner3: '@' }, /* 2 (2 PC Key)*/
      51: { row: 3, mask: 0x04, type: 'key', layoutRowOrder: 5, top1: 'MORADO', inner1: '3', inner2: '<div class="zx-key three"><span></span></div>', inner3: '#', top2: 'LINE' }, /* 3 (3 PC Key)*/
      52: { row: 3, mask: 0x08, type: 'key', layoutRowOrder: 6, top1: 'VERDE', inner1: '4', inner2: '<div class="zx-key four"><span></span></div>', inner3: '$', top2: 'OPEN#' }, /* 4 (4 PC Key)*/
      53: { row: 3, mask: 0x10, type: 'key', layoutRowOrder: 7, top1: 'CELESTE', inner1: '5', inner2: '<div class="zx-key five"><span></span></div>', inner3: '%', top2: 'CLOSE#' }, /* 5 (5 PC Key)*/
      54: { row: 4, mask: 0x10, type: 'key', layoutRowOrder: 8, top1: 'AMRLLO', inner1: '6', inner2: '<div class="zx-key six"><span></span><span></span></div>', inner3: '&', top2: 'MOVE' }, /* 6 (6 PC Key)*/
      55: { row: 4, mask: 0x08, type: 'key', layoutRowOrder: 9, top1: 'BLNCO', inner1: '7', inner2: '<div class="zx-key seven"><span></span></div>', inner3: '\'', top2: 'ERASE' }, /* 7 (7 PC Key)*/
      ...
      48: { row: 4, mask: 0x01, type: 'key', layoutRowOrder: 12, top1: 'NEGRO', inner1: '0', inner3: '_', top2: 'FORMAT' }, /* 0 (0 PC Key)*/
      219: { row: 7, mask: 0x01, shiftKey: 16, type: 'key', layoutRowOrder: 13, inner1: 'PARAR', oneAction: true }, /* BREAK (' PC Key) */

      8: { row: 4, mask: 0x01, shiftKey: 16, type: 'key', layoutRowOrder: 14, inner1: 'BORRAR', oneAction: true }, /* Delete (Delete PC Key) */
      9: { row: 4, mask: 0x02, shiftKey: 16, type: 'key', layoutRowOrder: 15, inner1: 'GRAF.', oneAction: true }, /* GRAPH (Tab PC Key)  */
      ...
      20: { row: 7, mask: 0x02, shiftKey: 16, type: 'key', layoutRowOrder: 26, inner1: 'MODO<br/>EXTENDIDO', oneAction: true, gridColumn: '1 / 3', gridRow: '3' }, /* EXTEND MODE (Caps lock PC Key) */
      221: { row: 3, mask: 0x01, shiftKey: 16, type: 'key', layoutRowOrder: 27, inner1: 'EDITAR', oneAction: true }, /* EDIT (¡ PC Key)  */
      ...
      13: { row: 6, mask: 0x01, type: 'key', layoutRowOrder: 38, inner1: '&#8626;', oneAction: true, gridColumn: '13 / 14', gridRow: '2 / 4' }, /* Enter (Enter PC Key) */

      500: { row: 0, mask: 0x01, type: 'key', layoutRowOrder: 39, inner1: '&#129081;', shift: true, oneAction: true, gridColumn: '1 / 3', gridRow: '4' }, /* CAPS SHIFT LEFT (Shift PC Key) */
      226: { row: 3, mask: 0x02, shiftKey: 16, type: 'key', layoutRowOrder: 40, inner1: '&#8691;', oneAction: true, lock: true }, /* CAPS LOCK (<> PC Key)  */
      ...
      16: { row: 0, mask: 0x01, type: 'key', layoutRowOrder: 49, inner1: '&#129081;', shift: true, oneAction: true, gridColumn: '12 / 14', gridRow: '4' },  /* CAPS SHIFT RIGHT (RIGHT LEFT PC Key) */

      17: { row: 7, mask: 0x02, type: 'key', layoutRowOrder: 50, inner1: 'CAMBIO', shift: true, oneAction: true }, /* SYMB SHIF (CTRL PC Key) */
      ...
      501: { row: 7, mask: 0x02, type: 'key', layoutRowOrder: 59, inner1: 'CAMBIO', shift: true, oneAction: true }, /* SYMB SHIF (CTRL PC Key) */
    };
  };
  getKeyCodes() {
